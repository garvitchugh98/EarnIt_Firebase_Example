...
//                    Log.d("Garvit log : ",image);
                 ...
                 //   String thumb_image = dataSnapshot.child("Thumb_Image").getValue().toString();
                    ...
                    Picasso.with(AccountSettingsActivity.this).load(image).into(mDisplayImage);
...
//                        Picasso.with(AllUsersActivity.this).load(image).placeholder(R.drawable.default_avatar).into(mDisplayImage);
                        ...
                        Picasso.with(AccountSettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            ...
                            public void onError() {
                                ...
                                Picasso.with(AccountSettingsActivity.this).load(image).placeholder(R.drawable.default_avatar).into(mDisplayImage);
...
//            Bundle bundle = data.getExtras();
            ...
            if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    mProgressDialog = new ProgressDialog(com.brss.earnit.AccountSettingsActivity.this);
                                            ...
                                            mUserDatabase.child("Image").setValue(download_url).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if(task.isSuccessful()){
                                                        ...
                                                        Toast.makeText(AccountSettingsActivity.this, "Success in Uploading.", Toast.LENGTH_LONG).show();
